...
Aufgabe:
Es sammelt alle Funksprüche, Türsensoren, Geigerzähler-Messungen und Wachberichte – also Logs – an einem Ort.
...
Alle Sensoren (Server, Firewalls, Endgeräte) melden an ein einziges Terminal.
• Ereigniskorrelation
Ein offenes Tor + deaktivierter Geschützturm + Bewegung im Sektor 3 = Kein Zufall.
Das ist ein koordinierter Raider-Angriff.
• Echtzeit-Alerting
Alarm geht los, bevor der erste Raider im Atrium steht.
• Compliance & Reporting
Vault-Tec möchte Berichte. Immer.
Regulatorik = Überlebensregeln.
...
Du bekommst:
Vorgefertigte Überwachungssysteme
Dashboards
Detection-Packs
...
Viele fertige Sicherheitsregeln
Integrierte Automatisierung (SOAR = automatische Geschütztürme)

🔴 Nachteile
Lizenzierung nach Ingest-Volumen (GB/Tag)
→ Je mehr Sensoren, desto teurer
Vendor Lock-in
...
Versprechen:
„Einziehen und sofort sicher.“
Die Technik erkennt Raider-Muster fast automatisch.
Du zahlst für Komfort.
...
Falsches Mapping = blinder Wachposten.
Elastic Security:
...
Reifegrad hängt vom Team ab
Mehr Konfigurationsarbeit
...
Schnell. Flexibel. Brutal effizient.
Aber du brauchst:
Einen guten Overseer.
...
Skalierbarkeit
Technische Freiheit
Beide können Enterprise-Security leisten.
Der Unterschied liegt im Betriebsmodell.
Entscheidungsfaktoren:
Budget (Kronkorken-Vorrat)
Log-Volumen (GB/Tag)
Team-Kompetenz
